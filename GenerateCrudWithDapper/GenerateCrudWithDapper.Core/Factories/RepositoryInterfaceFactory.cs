...
{
    internal class RepositoryInterfaceFactory : IFactory
    {
        private readonly IFactory _next;

        public RepositoryInterfaceFactory(IFactory next)
        {
            _next = next;
        }
        ...
        public void Execute(CrudGenerateDto value)
        {
            ...
            var interfaceName = $"I{value.RepositoryClassName}{StringConstant.Repository}";
